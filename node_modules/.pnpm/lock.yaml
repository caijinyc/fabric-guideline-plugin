...
packages:
  ...
  /@types/fabric/4.5.11:
    resolution: {integrity: sha512-JgOnbIm03EDYI+X5/hjstMZUbQ9W3704BQ4Dlu7t9JwWzNSdJE4cTV/4XtIHFCCfiFpcL756re+qCazTA84InA==}
    dev: true
  ...
  /canvas/2.9.3:
    resolution: {integrity: sha512-WOUM7ghii5TV2rbhaZkh1youv/vW1/Canev6Yx6BG2W+1S07w8jKZqKkPnbiPpQEDsnJdN8ouDd7OvQEGXDcUw==}
    engines: {node: '>=6'}
    requiresBuild: true
    dependencies:
      '@mapbox/node-pre-gyp': 1.0.9
  ...
  /fabric/5.2.1:
    resolution: {integrity: sha512-Irltx4i+aLccWgdQj2Uvrwh/XulDAqqYMZ1bI13fAtmlxl4ggobo0t7VVYy3Ob4YEB0sCeJZKE8ExZgGo/amkw==}
    engines: {node: '>=14.0.0'}
    optionalDependencies:
      canvas: 2.9.3
